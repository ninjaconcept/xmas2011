...
(function($){
	$.fn.snowfall = function(options){
		...
		function Flake(_x, _y, _size, _speed)
		{
			...
			var flakeMarkup = "<div class='flakes' id='flake-" + this.id + "' style='width: " + this.size + "px; height: " + this.size + "px; top: " + this.y + "px; left:" + this.x + "px; z-index: " + options.flakeIndex + ";'></div>";
